...
public class BookResourceTest {
    ...
    private static final LocalDate DEFAULT_PUBLISHDATE = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_PUBLISHDATE = LocalDate.now(ZoneId.systemDefault());
    private static final String DEFAULT_EDITION = "AAAAA";
    private static final String UPDATED_EDITION = "BBBBB";

    private static final Integer DEFAULT_SALES = 100;
    private static final Integer UPDATED_SALES = 99;
    ...
    public void initTest() {
        ...
        book.setPublishdate(DEFAULT_PUBLISHDATE);
        book.setEdition(DEFAULT_EDITION);
        book.setSales(DEFAULT_SALES);
    }
    ...
    public void createBook() throws Exception {
        ...
        assertThat(testBook.getPublishdate()).isEqualTo(DEFAULT_PUBLISHDATE);
        assertThat(testBook.getEdition()).isEqualTo(DEFAULT_EDITION);
        assertThat(testBook.getSales()).isEqualTo(DEFAULT_SALES);
    }
    ...
    public void getAllBooks() throws Exception {
        ...
        restBookMockMvc.perform(get("/api/books"))
                ...
                .andExpect(jsonPath("$.[*].publishdate").value(hasItem(DEFAULT_PUBLISHDATE.toString())))
    ...
    public void getBook() throws Exception {
        ...
        restBookMockMvc.perform(get("/api/books/{id}", book.getId()))
            ...
            .andExpect(jsonPath("$.publishdate").value(DEFAULT_PUBLISHDATE.toString()))
    ...
    public void updateBook() throws Exception {
        ...
        book.setPublishdate(UPDATED_PUBLISHDATE);
        book.setEdition(UPDATED_EDITION);
        book.setSales(UPDATED_SALES);
        ...
        assertThat(testBook.getPublishdate()).isEqualTo(UPDATED_PUBLISHDATE);
        assertThat(testBook.getEdition()).isEqualTo(UPDATED_EDITION);
        assertThat(testBook.getSales()).isEqualTo(UPDATED_SALES);
    }
